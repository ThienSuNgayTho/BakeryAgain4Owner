 ...
 * @author longv
 */
@WebServlet(name = "AddAccountOwnerController", urlPatterns = {"/AddAccountOwnerController"})
public class AddAccountOwnerController extends HttpServlet {
private final String ERROR_PAGE = "AddNewAccountOwnerPage.jsp";
    private final String SUCCESS_PAGE = "ManageUserOwnerController";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            log("AddNewAccountOwnerController _ SQL: " + ex.getCause());
        } catch (NamingException ex) {
            log("AddNewAccountOwnerController _ Naming: " + ex.getCause());
        } finally {
