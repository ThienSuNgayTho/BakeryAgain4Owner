 ...
 * @author longv
 */
@WebServlet(name = "ManageUserOwnerController", urlPatterns = {"/ManageUserOwnerController"})
public class ManageUserOwnerController extends HttpServlet {
    private final String USER_MANAGE_PAGE = "ManageAccountOwner.jsp";
    /**
...
//            }
        ...
        try {
            ...
            log("ManageUserOwnerController _ SQL " + ex.getCause());
        } catch (NamingException ex) {
            log("ManageUserOwnerController _ Naming " + ex.getCause());
        } finally {
