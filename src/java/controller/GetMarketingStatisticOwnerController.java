 ...
 * @author Admin
 */
@WebServlet(name = "GetMarketingStatisticOwnerController", urlPatterns = {"/GetMarketingStatisticOwnerController"})
public class GetMarketingStatisticOwnerController extends HttpServlet {

    private final String WEBOWNER_HOME_PAGE = "HomeWebownerMarketing.jsp";
