...
public class HomeController extends HttpServlet {
    ...
    private final String HOME_PAGE_WEBOWNER = "GetAdminStatisticOwnerController";
...
//            context.setAttribute("ALL_CATEGORY_LIST", categoryList);
            ...
            for (ProductDTO productDTO : productList) {
                if (!new ProductDAO().isAvailable(productDTO.getId())) {
                    productDTO.setStatus(false);
                }
            }
            System.out.println("Product 1:" + productList);
            ...
            if (user == null) {
                ...
                if (cookies != null) {
                    ...
                    if (result != null) {
                        ...
                        //if the user is webowner redirect to marketing homepage
                        if (result.getRole().getRoleId() == 4) {
                            url = HOME_PAGE_WEBOWNER;
                        }
